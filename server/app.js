...
app.post('/postParking',(req, res)=>{
    ...
    db.query(update, [INparking_time,INtotal_price,INcheck_in,INcheckout,INspace_id,INcustomerID], (err, result)=>{
        if(err){
            console.log(err);
        }
        else{
...
app.post('/CreateCustomer',(req, res) => {
    ...
    db.query(post, [customerID,Fname,Lname,tel,id_card_no,userID], (err, result)=>{
        if(err){
            console.log(err);
        }
        else{
