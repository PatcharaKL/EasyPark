          ...
          <TouchableOpacity
            ...
            <View
              ...
              <Image
                ...
                style={styles.image}
              />
              <Text style={{color: '#000', fontSize: 15}}>Paying methods</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={goToParking}
            ...
            <View
              ...
              <Image
                ...
                style={styles.image}
              />
              <Text style={{color: '#000', fontSize: 15}}>Parking</Text>
            </View>
          </TouchableOpacity>
        </View>
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <Image
                ...
                style={styles.image}
              />
              <Text style={{color: '#000', fontSize: 15}}>Parking History</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
            ...
            <View
              ...
              <Image
                ...
                style={styles.image}
              />
              <Text style={{color: '#000', fontSize: 15}}>Logout</Text>
            </View>
          </TouchableOpacity>
